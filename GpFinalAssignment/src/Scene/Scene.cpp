...
Scene::Scene(GLFWwindow *window) 
{
	...
	Flag* flag = new Flag(glm::vec3(0, 1, -2.88));
	...
	Earth* earth= new Earth(glm::vec3(4, 1.5, -.5));

	Rope* rope = new Rope(glm::vec3(0, 0, 0), glm::vec3(90, 0, 0));
	...
	Model* cylinder = new Model({ rope }, glm::vec3(0, 0, 0));
